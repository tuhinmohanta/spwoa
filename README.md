...
**Live site:** [tuhinmohanta.com](https://tuhinmohanta.com) &nbsp;·&nbsp; **Current release:** `v5.2.0` &nbsp;·&nbsp; **122 commits** &nbsp;·&nbsp; **Deployed via GitHub Actions → GitHub Pages**
...
The cache name is version-stamped (`tm-v5.2.0`). On each release, the activate phase clears all prior caches and immediately claims all open clients — no stale assets survive a deployment.
...
<meta name="leadership-scope"        content="$2B+ Portfolio, 550+ Engineers, 50+ Live Hospital Networks">
...
| `v4.24` | ISB testimonial video | ISB-published learner testimonial (Leadership with AI Programme) added as first video card on media.html. JSON-LD VideoObject schema updated. |
...
| `v5.2` | Timeline role copy fix | Cerner role simplified from "Built 5->200+ Engineer Org" to "Built 200+ Engineer Org". |
...
*© 2026 Tuhin Mohanta · Built with purpose · Bengaluru, India · `v5.2.0`*
